...
| `Personnel                          : pph_pernr;      // Name 'Personnel' is deprecated but already used in I_ProductionOrdConfirmationTP` | `Personnel                          : pph_pernr;      // Name 'Personnel' is deprecated but already used in I_ProductionOrdConfirmationTP` |
