...
| `case when REValuationCashflow.RECashFlowType = '1' or REValuationCashflow.RECashFlowType = '3'` | `case when REValuationCashflow.RECashFlowType = '1' or REValuationCashflow.RECashFlowType = '3'` |
| `then` | `then` |
