...
| `/scmtms/vdm_sc_item_12_uuid preserving type)` | `cast(scale_item_key12` |
| `/scmtms/vdm_sc_item_13_uuid preserving type)` | `cast(scale_item_key13` |
| `/scmtms/vdm_sc_item_14_uuid preserving type)` | `cast(scale_item_key14` |
