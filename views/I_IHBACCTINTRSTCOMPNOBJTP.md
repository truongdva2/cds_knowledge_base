...
| `_IHBGroupAssignmentTP       : redirected to composition child I_IHBAcctIntrstCompnItmTP` | *Association* |
| `_IHBAcctIntrstCompnTP       : redirected to composition child I_IHBAcctIntrstCompnTP` | *Association* |
