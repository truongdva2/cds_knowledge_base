...
| `OrderConfirmationRecordType     : co_satza;      // only relevant for time event` | `OrderConfirmationRecordType     : co_satza;      // only relevant for time event` |
...
| `ConfirmationReworkQuantity      : ru_rmnga;` | `ConfirmationReworkQuantity      : ru_rmnga;` |
