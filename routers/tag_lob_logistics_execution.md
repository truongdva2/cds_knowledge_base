# Router: lob:logistics execution

**Keywords / Description:** LE, Shipping, Transportation, Warehouse Management, Delivery, EWM

This is a routing index for all CDS views tagged with `lob:logistics execution`.
