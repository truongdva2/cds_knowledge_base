# Router: component:ca_wfd-int

**Keywords / Description:** Ca Wfd-int, Cross-Application, CA, CA-WFD-INT

This is a routing index for all CDS views tagged with `component:ca_wfd-int`.
