# Router: component:ppm_scl-str

**Keywords / Description:** Ppm Scl-str, Portfolio and Project Management, PPM, PPM-SCL-STR

This is a routing index for all CDS views tagged with `component:ppm_scl-str`.
